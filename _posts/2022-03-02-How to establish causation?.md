...
Here $$ \hat{y} $$ is the estimated values of $$ y $$ and they are also known as "fitted" or "predicted" values. This Least squares equation allows us to estimate "Daily crime total", given input values for our variable $$ x_{1} $$ and $$ x_{2} $$.
