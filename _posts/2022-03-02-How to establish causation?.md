...
<span style="font-size:0.85em;">$$ y=\beta_{0}+\beta_{1} y_{1}+\beta_{2} \log \left(x_{2}\right)+\epsilon $$</span>
...
<span style="font-size:0.90em;">$$ \hat{y} = -6.046x_{1} + 17.341\log\left(x_{2}\right) $$</span>
